...
public class ViewDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FLat No.", "Flat Maintenance", "Vechile Maintenance", "Water Bill", "Parking Bill", "Month", "Total", "Status"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 143, 588, 90));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View Bills.png"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(107, 23, 97, -1));
